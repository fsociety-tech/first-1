...
def recognize_emotion():
    ...
    if pred == 0:
        tune = mp.newMedia("songs/angry/angry.mp3")
        print("Angry song is playing.")
    elif pred == 1:
        tune = mp.newMedia("songs/happy/happy.mp3")
        print("Happy song is playing.")
    elif pred == 2:
        tune = mp.newMedia("songs/sad/sad.mp3")
        print("Sad song is playing.")
    elif pred == 3:
        tune = mp.newMedia("songs/neutral/neutral.mp3")
        print("Nuetral song is playing.")
    elif pred == 4:
        tune = mp.newMedia("songs/surprise/surprise.mp3")
